...
public class HashSetChaining {
	...
	public boolean remove(Object x) {
		int objectHashValue = hashValue(x);
		Node previousNode = null;
		Node currentNode = buckets[objectHashValue];

		while (currentNode != null) {
			if (currentNode.data.equals(x) && previousNode == null) {
				buckets[objectHashValue] = null;
				return true;
			} else if (currentNode.data.equals(x) && previousNode != null) {
	...
	private void rehash(){
		...
		for (Node currentNode : previousBuckets) {
			while (currentNode != null) {
				add(currentNode);
				currentNode = currentNode.next;
			}
