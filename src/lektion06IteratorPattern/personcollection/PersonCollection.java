...
public class PersonCollection implements PersonCollectionI{
    ...
    public class PersonCollectionIterator implements Iterator<Person> {
        ...
        private int expectedModifiedCount = PersonCollection.this.modifiedCount;

        public PersonCollectionIterator() {}

        @Override
        public boolean hasNext() {
            return persons[position] != null;
        }
        ...
        public Person next() {
            ...
            Person nextPerson = persons[position];
            position++;
            return nextPerson;
        }
        ...
        public void remove() {
            ...
            PersonCollection.this.remove(position--);
            position--;
            expectedModifiedCount = PersonCollection.this.modifiedCount;
        }
    }
